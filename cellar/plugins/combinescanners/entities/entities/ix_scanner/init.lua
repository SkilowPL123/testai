...
function ENT:Die(dmgInfo)
	...
	local letter = dispatch.AddWaypoint(pos, "SKANER ZNISZCZONY", "death", 60)
	Schema:AddCombineDisplayMessage(string.format("Etykieta %s: utracono sygnał ze skanera obsługiwanego przez funkcjonariusza!", letter), color_red)
end
