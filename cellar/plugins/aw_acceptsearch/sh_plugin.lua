...
if CLIENT then
    ...
    function PANEL:Init()
        ...
        self.Paint = function(this,w,h)
            ...
            surface.DrawText("Postać "..self:GetData().." chce ciebie przeszukać", true)

            surface.SetFont("cellar.f3.btn")
            surface.SetTextColor(color[1])
            surface.SetTextPos(w2,h2)
            surface.DrawText("Character "..self:GetData().." chce ciebie przeszukać", true)
        end
