...
function PANEL:Init()
	...
	self.buttonpanel.Paint = function(me)
		if LocalPlayer():IsSuperAdmin() then
			draw.SimpleText("MENU", "cellar.tab", ScrW() - ScrW()/2, ScrH() - ScrH()/1.37 - 40 - 20, cellar_blue, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			draw.SimpleText("MENU", "cellar.tab.blur", ScrW() - ScrW()/2, ScrH() - ScrH()/1.37 - 40 - 20, cellar_blue, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		else
			draw.SimpleText("MENU", "cellar.tab", ScrW() - ScrW()/2, ScrH() - ScrH()/1.6 - 40 - 20, cellar_blue, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			draw.SimpleText("MENU", "cellar.tab.blur", ScrW() - ScrW()/2, ScrH() - ScrH()/1.6 - 40 - 20, cellar_blue, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		end
	end
