...
function PANEL:Paint(w, h)
	...
	draw.SimpleText("Wersja beta: niektóre funkcje mogą być niedostępne lub mogą nie działać prawidłowo.", "cellar.tab",  ScrW() - ScrW()/2, ScrH() - ScrH()/2.4, ColorAlpha(color_orange,  90 + tsin), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	draw.SimpleText("Wersja beta: niektóre funkcje mogą być niedostępne lub mogą działać nieprawidłowo.", "cellar.tab.blur",  ScrW() - ScrW()/2, ScrH() - ScrH()/2.4, ColorAlpha(color_orange,  90 + tsin), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)



	draw.SimpleText("Projekt i funkcjonalność oryginalnego interfejsu użytkownika", "cellar.watermark", ScrW() - ScrW()/2, ScrH() - ScrH()/1.7, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	draw.SimpleText("został napisany, zaprojektowany i dostarczony przez Zespół Cellar.", "cellar.watermark", ScrW() - ScrW()/2, ScrH() - ScrH()/1.7 + 24, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
