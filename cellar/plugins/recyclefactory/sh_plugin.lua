...
PLUGIN.VariantsUse = {
	Rozpocznij = function(ent) if !ent:GetIsWorking() then ent:StartWork() end end,
	Zatrzymywaj = function(ent) if ent:GetIsWorking() then ent:StopWork() end end,
	Rozladuj = function(ent) ent:Eject() end,
}
