...
function guild_meta:Initialize(id, owner, name)
  ...
  self.groups = {}
  self.invites = {}
  self.members = { [owner] = { role = 'Właściciel', privileges = {}, group = nil } }
  self.roles = {
    ['Właściciel'] = { role = 'Właściciel', privileges = { [GUILD_ENUM_PRIVILEGES.ALL] = true }, no_edit = true },
    ['Członek'] = { role = 'Członek', privileges = {} }
  }
end
