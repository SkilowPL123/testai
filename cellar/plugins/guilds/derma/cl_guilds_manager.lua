...
function PANEL:Init()
  ...
  self:Center()
  self:MakePopup()
  self:SetTitle('Uproszczony menedżer gildii')
  ...
  self.sheet:AddSheet('Lista gildii', self.editor, 'icon16/book_add.png')
end
...
function PANEL:get_guild_data(...)
  ...
  create_entry('Balansować', function()
  ...
  create_entry('Opis', function()
    ...
    entry.OnMousePressed = function(this, key)
      ...
      Derma_StringRequest('Opis gildii', '', this:GetText(), function(text)
        this:SetText(text)
        this:SizeToContents()
  ...
  members:AddColumn('Nazwa')
  members:AddColumn('Rola')
  members:AddColumn('Grupa')
  members:SetZPos(5)
  ...
  update:SetText('Aktualizuj konfigurację')
