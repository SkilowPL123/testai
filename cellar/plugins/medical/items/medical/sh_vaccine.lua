ITEM.name = "Strzykawka ze szczepionką \"AZV-01\""
ITEM.description = "Schludna plastikowa strzykawka z iniektorem, zawierająca przezroczystą ciecz bez smaku, zapachu i koloru. Osoba, która przyjmie tę szczepionkę, odczuje jedynie lekkie bóle głowy przez tydzień oraz biegunkę, ale zapewni ona ochronę przed nieprzewidzianymi konsekwencjami. Zgodnie z etykietą, szczepionkę należy przyjąć przed 31 grudnia 2021 roku, w przeciwnym razie ulegnie zepsuciu i nie zapewni już ochrony po podaniu."
...
if CLIENT then
	...
	function ITEM:PopulateTooltip(tooltip)
		...
		skill:SetText("Wymagana umiejętność medycyny 2")
	end
end
