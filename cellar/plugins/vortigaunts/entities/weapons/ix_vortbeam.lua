...
SWEP.Instructions = "LMB: Wystrzeliwuje wiązkę elektryczną Vortesencji."
SWEP.Purpose = ""
SWEP.Contact = ""
SWEP.Author	= ""
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:Health() <= 50 or v_thirst < 0 or v_hunger < 0 then
		if SERVER then
			self.Owner:NotifyLocalized("Jesteś zbyt słaby, aby używać swoich mocy!")
		end
