...
local function CreateObjectPanel()
	...
	local containers = tree:AddNode("Kontenery", "icon16/package.png")
	...
	local beds = tree:AddNode("Łóżka", "icon16/heart.png")
...
spawnmenu.AddCreationTab("Obiekty", CreateObjectPanel, "icon16/script_key.png")
