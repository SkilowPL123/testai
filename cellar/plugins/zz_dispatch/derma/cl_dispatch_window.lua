...
do
	...
	function PANEL:Init()
		...
		do
			...
			self.manpower:SetWindowName("MIESZANINA")
			self.manpower.stats = {}
		...
		do
			...
			frame:SetWindowName("PT I NADZÓR")
	...
	function PANEL:SwitchStability() 
		...
		for k, v in ipairs(dispatch.stability_codes) do
			menu:AddOption(v.name, function()
				Derma_Query(string.format("Czy jesteś pewien i chcesz zmienić bieżący kod stanu na %s?", v.name), "Zmiana kodu stanu", "Zastosuj", function()
