...
function PANEL:SetButtonState(bool)
	self.create_squad:SetText(bool and "STWÓRZ GRUPĘ PATROLOWĄ" or "OPUŚĆ GRUPĘ PATROLOWĄ")
	self.create_squad.DoClick = function()
