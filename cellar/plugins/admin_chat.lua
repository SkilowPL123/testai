...
ix.command.Add("Discord", {
	description = "Link do serwera Discord.",
...
ix.command.Add("Content", {
	description = "Link do zawartości serwera.",
	OnRun = function(self, client)
		net.Start("ixOpenURL")
			net.WriteUInt(1, 3)
		net.Send(client)
...
ix.command.Add("Guide", {
	description = "Link do przewodnika po serwerze.",
	OnRun = function(self, client)
		net.Start("ixOpenURL")
			net.WriteUInt(2, 3)
		net.Send(client)
...
ix.command.Add("Rules", {
	description = "Link do regulaminu serwera.",
	OnRun = function(self, client)
		net.Start("ixOpenURL")
			net.WriteUInt(3, 3)
		net.Send(client)
...
ix.command.Add("Video", {
	description = "Link do wideoprzewodnika po serwerze.",
	OnRun = function(self, client)
		net.Start("ixOpenURL")
			net.WriteUInt(4, 3)
		net.Send(client)
