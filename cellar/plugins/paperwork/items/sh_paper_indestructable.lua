...
ITEM.name = "Broszura ogłoszeń"
ITEM.model = "models/props_office/notepad_office.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.description = "Broszura ta ma wiele stron i bardzo łatwo ją przeglądać. Zawiera sporo informacji, które mogą Ci się przydać."
ITEM.isPaper = true
