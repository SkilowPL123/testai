ITEM.name = "Maska gazowa „Czystsza”"
ITEM.model = "models/cellar/items/city3/clothing/worker_helmet.mdl"
ITEM.width = 2 -- ширина
ITEM.height = 2 -- высота
ITEM.description = "Maska, która może przypominać nam o najstraszniejszych wydarzeniach, które już miały miejsce lub będą miały miejsce dopiero w przyszłości."
