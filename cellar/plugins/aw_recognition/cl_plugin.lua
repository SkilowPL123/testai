...
local VariantsSetsName = {
	["Nowa nazwa"] = function(panel)
		Derma_StringRequest("Dodanie nowej nazwy dla widoków","Wprowadź nową nazwę","Andriej",function(text)
			...
			end,nil,"Dodaj","Anuluj")
	 end,
	["Prawdziwe imię"] = function() AW_RECOGNIZE_SELECTEDNAME = LocalPlayer():Name() end,
}
...
function PANEL:Init()
	...
	self.PaintOver = function(this,w,h)
        ...
        local text = AW_RECOGNIZE_SELECTEDNAME or "nie wybrano"
        color = btnColors[2]
...
function PANEL:LoadNames()
	...
	for k,v in pairs(Names) do
		...
		button.DoClick = function(this)
			Derma_Query("Przedstaw się pod swoim imieniem i nazwiskiem "..k.."?","Wybierz operację","Wybierz",
			function() 
