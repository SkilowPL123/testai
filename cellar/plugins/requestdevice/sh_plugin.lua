...
function PLUGIN:InitializedChatClasses()
	...
	ix.chat.Register("request_loopback", {
		color = Color(255, 165, 32),
		format = "Urządzenie wzywające transmituje \"%s\"",
		OnChatAdd = function(class, speaker, text)
...
ix.lang.AddTable("russian", {
	rdNotFound = "Nie znaleziono urządzenia wzywającego o tym samym CID lub przekroczono czas odpowiedzi!",
})