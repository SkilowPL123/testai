...
PLUGIN.slotPlacements = {
	[EQUIP_HEAD] = {x = 6, y = 30, text = "Głowa"},
	[EQUIP_MASK] = {x = 6, y = 100 + 8, text = "Twarz"},
	[EQUIP_TORSO] = {x = 6, y = 170 + 16, text = "Tułów"},
	[EQUIP_LEGS] = {x = 285, y = 275, text = "Spodnie"},
	[EQUIP_HANDS] = {x = 285, y = 170 + 16, text = "Ręce"},
	[EQUIP_RADIO] = {x = 6, y = 300, text = "Radio"},
	[EQUIP_CID] = {x = 6, y = 370 + 16, text = "CID"},
	[EQUIP_EARS] = {x = 285, y = 30, text = "Uszy"}, 
	[EQUIP_RESERVED1] = {x = 285, y = 100 + 8, text = "Ramię"},
	[EQUIP_BUTY] = {x = 285, y = 375, text = "Buty"},
}
...
function PANEL:Paint()
	...
	--surface.DrawText("Sprzęt")
	--draw.SimpleText("Sprzęt", "cellar.main.btn", self:GetWide()/2, self:GetTall() * .035, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
end
